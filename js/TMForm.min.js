//TMForm 1.0.1
!function(e){e.fn.TMForm=function(s){function a(){function a(){i.on("submit",n).on("reset",o).on("focus","[data-constraints]",function(){e(this).parents("label").removeClass(s.emptyClass)}).on("blur","[data-constraints]:not(.once-verified)",function(){e(this).addClass(s.onceVerifiedClass).trigger("validate.form")}).on("keyup","[data-constraints].once-verified",function(){e(this).trigger("validate.form")}).on("keydown","input",function(s){var a=e(this),t=a.parents("label").next("label").find("input,textarea");13===s.keyCode&&(t.length?t.focus():i.submit())}).on("keydown","textarea",function(s){13===s.keyCode&&s.ctrlKey&&e(this).parents("label").next("label").find("input,textarea").focus()}).on("change",'input[type="file"]',function(){e(this).parents("label").next("label").find("input,textarea").focus()}).attr({method:"POST",action:s.mailHandlerURL}),0!==e("[data-constraints]",i).length&&e("[data-constraints]",i).regula("bind").on("show.placeholder",function(){l(e(this))}).on("validate.form",t),e("[placeholder]",i).TMPlaceholder(),e("[data-type=submit]",i).click(function(){return i.trigger("submit"),!1}),e("[data-type=reset]",i).click(function(){return i.trigger("reset"),!1}),s.stripHTML&&i.append('<input type="hidden" name="stripHTML" value="true">'),0!==e("label.recaptcha",i).length&&window.Recaptcha&&r()}function t(a){var a=e(this),t=a.regula("validate"),l=!1,n=!1,o=!!~a.data("constraints").indexOf("@Required");e.each(t,function(){"Required"===this.constraintName?l=!0:n=!0}),a.hasClass(s.onceVerifiedClass)||l||a.addClass(s.onceVerifiedClass),l&&a.parents("label").addClass(s.emptyClass),n&&!l&&o&&a.parents("label").removeClass(s.emptyClass).removeClass(s.okClass).addClass(s.invalidClass),n&&!o&&a.val()&&a.parents("label").removeClass(s.emptyClass).removeClass(s.okClass).addClass(s.invalidClass),t.length||a.parents("label").removeClass(s.invalidClass).removeClass(s.emptyClass).addClass(s.okClass)}function l(e){e.removeClass(s.onceVerifiedClass).parents("label").removeClass(s.invalidClass).removeClass(s.emptyClass).removeClass(s.okClass)}function n(){var a,t=e(this),l=e("."+s.responseMessageClass);return l.on("hidden.bs.modal",function(){"success"!==a&&(e("#recaptcha_reload",i).click(),e("#recaptcha_response_field",i).focus())}),e("[data-constraints]",i).trigger("validate.form"),""===e("#recaptcha_response_field",i).val()&&e("label.recaptcha",i).addClass(s.emptyClass),e("label."+s.invalidClass+",label."+s.emptyClass,i).length||i.hasClass(s.processingClass)||(i.addClass(s.processingClass),t.ajaxSubmit(function(t,n,o,r){a=t,"success"==t?(i.removeClass(s.processingClass).addClass(s.successClass),l.find(".modal-title"),l.find(".modal-body"),setTimeout(function(){i.removeClass(s.successClass).trigger("reset")},s.successShowDelay)):(l.find(".modal-title").text("Chyba!"),l.find(".modal-body").html(t),i.removeClass(s.processingClass).addClass(s.responseErrorClass),e("#recaptcha_response_field",i).val(""),setTimeout(function(){i.removeClass(s.responseErrorClass)},s.successShowDelay)),l.modal({keyboard:!0})})),!1}function o(){l(e("[data-constraints]",i))}function r(){e("label.recaptcha",i).append('<div id="captchadiv"></div>'),Recaptcha.create(s.recaptchaPublicKey,"captchadiv",{theme:s.capchaTheme}),i.on("focus","#recaptcha_response_field",function(){e(this).parents("label").removeClass(s.emptyClass)})}var i=e(this);s=e.extend({okClass:"ok",emptyClass:"empty",invalidClass:"invalid",successClass:"success",responseErrorClass:"response-error",responseMessageClass:"response-message",processingClass:"processing",onceVerifiedClass:"once-verified",successShowDelay:"4000",stripHTML:!0,recaptchaPublicKey:"",capchaTheme:"clean"},s),a()}return this.each(a)}}(jQuery),function(e){e.fn.TMPlaceholder=function(s){return this.each(function(){function a(){t=n.attr("placeholder"),l=e(document.createElement("span")),l.addClass(s.placeholderClass).css({left:n.prop("offsetLeft"),top:n.prop("offsetTop"),width:n.width(),height:n.outerHeight()}).text(t).appendTo(n.parent()).click(function(){return n.focus(),!1}).on("contextmenu",function(){n.trigger("hide.placeholder").focus()}),n.val("").removeAttr("placeholder").on("hide.placeholder",function(){l.addClass(s.placeholderHiddenClass)}).on("show.placeholder",function(){l.removeClass(s.placeholderHiddenClass)}).on("focus",function(){l.addClass(s.placeholderFocusedClass)}).on("blur",function(){var e=n.val();(""===e||e===t)&&(n.val(""),n.trigger("show.placeholder")),l.removeClass(s.placeholderFocusedClass)}).on("keydown",function(e){(32===e.keyCode||e.keyCode>46)&&n.trigger("hide.placeholder")}).on("keyup",function(){return""===n.val()?(n.trigger("show.placeholder"),!1):void n.trigger("hide.placeholder")}).parents("form").on("reset",function(){n.trigger("show.placeholder")})}var t,l,n=e(this);s=e.extend({placeholderClass:"_placeholder",placeholderFocusedClass:"focused",placeholderHiddenClass:"hidden"},s),a()})}}(jQuery);
...
regula.custom({
	name:'JustNumbers'
	,validator:function(){
		return /^\+?(\d[\d\/\-\+\(\) ]{5,}\d$)/.test(this.value)   //allow only diggits and  +, - , /
	}
})
regula.custom({
	name:'Ignore'
